...
def evaluate_and_save_model(args,model,eval_dataset,epoch,global_step,best_f1):
    ...
    if avg_f1 > best_f1:
        best_f1 = avg_f1
        torch.save(model.state_dict(), os.path.join(args.output_dir, "best_ner1.bin"))
...
def main():
    ...
    # Other parameters
    parser.add_argument("--pre_train_model", default='input/config/best_ner.bin', type=str, required=False,
